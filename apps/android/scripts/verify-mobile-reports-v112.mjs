...
const checks=[
 ...
 [screen.includes("inspectLocalBackup")&&backup.includes("inspectPickedLocalBackup")&&backup.includes("DocumentPicker.getDocumentAsync"),"backup file inspection is available without restore"]
];
