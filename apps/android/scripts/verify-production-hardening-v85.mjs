...
const validVersionContext=/^\d+\.\d+\.\d+$/.test(pkg.version)&&pkg.version===app.expo?.version&&expo57&&pkg.dependencies?.["react-native"]==="0.86.3"&&app.expo?.android?.versionCode===11;
