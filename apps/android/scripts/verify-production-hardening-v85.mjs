...
const validVersionContext=pkg.version==="1.0.6"&&pkg.dependencies?.expo==="~56.0.0"&&pkg.dependencies?.["react-native"]==="0.85.3"&&app.expo?.version==="1.0.6"&&app.expo?.android?.versionCode===8;
