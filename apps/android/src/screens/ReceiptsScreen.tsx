...
const s=StyleSheet.create({screen:{flex:1,backgroundColor:theme.background,padding:18},title:{fontSize:28,fontWeight:"800",color:theme.text,textAlign:"right",marginTop:12},subtitle:{color:theme.muted,textAlign:"right",marginBottom:14},card:{backgroundColor:"#fff",borderRadius:18,padding:16,gap:10,borderWidth:1,borderColor:theme.border},input:{backgroundColor:"#F8FAFC",borderWidth:1,borderColor:theme.border,borderRadius:12,padding:12,textAlign:"right"},payments:{flexDirection:"row",flexWrap:"wrap",gap:7},payment:{paddingVertical:8,paddingHorizontal:10,borderRadius:10,backgroundColor:"#F1F5F9"},active:{backgroundColor:theme.primary},paymentText:{color:theme.text,fontSize:12},activeText:{color:"#fff",fontWeight:"700",fontSize:12},progressBox:{flexDirection:"row",alignItems:"center",justifyContent:"center",gap:7,backgroundColor:theme.primarySoft,borderRadius:10,padding:9},progressText:{color:theme.primary,fontWeight:"700",fontSize:12},button:{backgroundColor:theme.primary,borderRadius:12,padding:14,alignItems:"center",justifyContent:"center",flexDirection:"row",gap:7},buttonText:{color:"#fff",fontWeight:"800"},history:{fontSize:18,fontWeight:"800",textAlign:"right",marginTop:18,color:theme.text},list:{gap:10,paddingVertical:12,paddingBottom:100},item:{backgroundColor:"#fff",borderRadius:16,padding:15,borderWidth:1,borderColor:theme.border},row:{flexDirection:"row",alignItems:"center",gap:12},num:{fontWeight:"800",color:theme.primary,textAlign:"right"},itemTitle:{fontSize:16,fontWeight:"800",color:theme.text,textAlign:"right"},itemText:{fontSize:13,color:theme.muted,textAlign:"right"},amount:{fontSize:18,fontWeight:"800",color:theme.text,textAlign:"right",marginTop:5},pdfState:{width:72,alignItems:"center",gap:3},pdfOk:{fontSize:11,color:theme.primary,fontWeight:"700"},pdfMissing:{fontSize:11,color:theme.muted,fontWeight:"700"},empty:{textAlign:"center",color:theme.muted,padding:30},cancelled:{fontSize:11,color:"#B42318",fontWeight:"800"},cancelLink:{fontSize:11,color:"#B42318",fontWeight:"700",marginTop:5},modalBackdrop:{flex:1,backgroundColor:"rgba(15,23,42,.45)",justifyContent:"center",padding:22},modalCard:{backgroundColor:"#fff",borderRadius:18,padding:18,gap:12},modalTitle:{fontSize:20,fontWeight:"800",color:theme.text,textAlign:"right"},modalText:{color:theme.muted,textAlign:"right",lineHeight:20},reasonInput:{minHeight:90,textAlignVertical:"top"},modalActions:{flexDirection:"row",gap:10,justifyContent:"flex-start"},secondaryButton:{paddingVertical:12,paddingHorizontal:18,borderRadius:12,backgroundColor:"#F1F5F9"},dangerButton:{paddingVertical:12,paddingHorizontal:18,borderRadius:12,backgroundColor:"#B42318"},dangerText:{color:"#fff",fontWeight:"800"},customerChooser:{gap:6},customerButton:{flexDirection:"row",alignItems:"center",gap:10,backgroundColor:theme.primarySoft,borderWidth:1,borderColor:theme.primary,borderRadius:12,padding:12},customerButtonTitle:{fontWeight:"800",color:theme.text,textAlign:"right"},customerButtonSub:{fontSize:12,color:theme.muted,textAlign:"right",marginTop:2},clearCustomer:{fontSize:12,color:theme.primary,fontWeight:"700",textAlign:"right"},inlineCustomerPanel:{gap:8,borderWidth:1,borderColor:theme.border,borderRadius:14,padding:10,backgroundColor:"#F8FAFC"},inlineCustomerHeader:{flexDirection:"row-reverse",alignItems:"center",justifyContent:"space-between"},inlineCustomerTitle:{fontSize:15,fontWeight:"800",color:theme.text,textAlign:"right"},inlineCustomerEmpty:{textAlign:"center",color:theme.muted,padding:14},customerRow:{flexDirection:"row",alignItems:"center",gap:10,borderWidth:1,borderColor:theme.border,borderRadius:14,padding:12,backgroundColor:"#fff"},customerRowTitle:{fontSize:16,fontWeight:"800",color:theme.text,textAlign:"right"},customerRowText:{fontSize:12,color:theme.muted,textAlign:"right",marginTop:2}});
