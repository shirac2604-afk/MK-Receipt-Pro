...
const checks=[
  ...
  [renderer.includes("קישור השחזור אומת")&&renderer.includes("completePasswordRecovery")&&!renderer.includes('autoComplete="one-time-code"'),"Windows UI accepts a password only after the main process verifies the link"],
