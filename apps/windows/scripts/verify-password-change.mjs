...
const checks=[
  ...
  [service.includes("async requestPasswordRecovery")&&service.includes("async completePasswordRecovery"),"password recovery is delegated to the dedicated Phase 15 flow"],
