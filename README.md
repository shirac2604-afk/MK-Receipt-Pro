...
## מצב מסירה עדכני — 30.08.2026

- `main` כולל את הגרסאות שנבדקו בפועל: **Windows 1.1.14** ו־**Android 1.0.10** (`versionCode` 11).
- שתי ההתקנות נבדקו כשדרוגים על גבי הקיים: סנכרון ענן, Google Drive ב־Windows, ניהול תלמידים, יומן, קבלות וגלילת היסטוריית הקבלות תקינים.
- PR #27 מוזג ל־`main`; אין PR פתוח או שינוי Production ממתין מהמסירה הזו.
- מסמך שוויון הפלטפורמות מפרט במדויק מה כבר קיים ומה מתוכנן: `docs/PLATFORM_PARITY_AND_VISUAL_REFRESH.md`.

## היסטוריית שלבי אבטחה — 26.08.2026
